export const environment = {
  production: true,
  apiUrl: 'https://api.way2wear.in/api/v1', //'https://way2wear-backend-production.up.railway.app/api/v1',
  openaiModel: 'gpt-4o',
  appVersion: '1.0.0',
  amazonAffiliateTag: 'way2wear-20',
  linkedinUrl: 'https://www.linkedin.com/in/manoj-a-57095216b',
  firebase: {
